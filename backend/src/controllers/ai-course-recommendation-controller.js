import { getPersonalizedRecommendations } from '../services/ai/personalized-course-recommendation-service.js';
...
export const getRecommendationHealth = async (req, res) => {
  try {
    const { checkGroqHealth } = await import('../utils/ai-providers/groq-client.js');
